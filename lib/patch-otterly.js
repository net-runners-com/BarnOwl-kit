...
const RESUME_REPLACEMENT = [
  "        // barnowl: resume by session id — continue via claude --resume",
...
function ensurePatched() {
  ...
  // routes-openai.js: HTTP sessions (resume by session id + id in responses)
  ...
  const results = [
    ...
    routesResult, resumeResult, sessionRespResult, sessionStreamResult,
  ];
