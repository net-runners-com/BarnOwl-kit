...
// The list installs before 2026-09 carry. gpt-5.6-sol / gpt-5.4 / gpt-5.4-mini
// now 400 on ChatGPT accounts, so migrateBlock() swaps this for the list above.
const CODEX_MODELS_REPLACEMENT_V1 = [
  '{ id: "claude-3-5-haiku-20241022", label: "Claude 3.5 Haiku", contextWindow: 200000 },',
...
function ensurePatched() {
  ...
  const codexModelsMigrateResult = migrateBlock(modelsCatalog, CODEX_MODELS_REPLACEMENT_V1, CODEX_MODELS_REPLACEMENT);
